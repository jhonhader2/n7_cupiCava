        ...
        if (comando.equals(SELECCIONAR)) {
            ...
            if (jf.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
                ...
                if (nombre.endsWith(".jpg")) {
                    ...
                    JOptionPane.showMessageDialog(this, "Debe seleccionar un archivo en formato .jpg.",
                            "Seleccionar imagen", JOptionPane.ERROR_MESSAGE);
                }
            }
            ...
            if (nombre != null && !nombre.isEmpty() && anhoS != null && !anhoS.isEmpty() && azucarS != null
                    && !azucarS.isEmpty() && lugar != null && !lugar.isEmpty() && imagen != null && !imagen.isEmpty()) {
                try {
                        ...
                        if (azucar >= 0) {
                            if (tipo.equals(Vino.SECO) && azucar > 5) {
                                JOptionPane.showMessageDialog(this,
                                        "El contenido en azúcar debe estar entre 0 y 5 si el tipo es seco.",
                                        "Agregar vino", JOptionPane.ERROR_MESSAGE);
                            } else if (tipo.equals(Vino.ABOCADO) && (azucar < 5 || azucar > 15)) {
                                JOptionPane.showMessageDialog(this,
                                        "El contenido en azúcar debe estar entre 5 y 15 si el tipo es abocado.",
                                        "Agregar vino", JOptionPane.ERROR_MESSAGE);
                            } else if (tipo.equals(Vino.SEMI_SECO) && (azucar < 15 || azucar > 30)) {
                                JOptionPane.showMessageDialog(this,
                                        "El contenido en azúcar debe estar entre 15 y 30 si el tipo es semi seco.",
                                        "Agregar vino", JOptionPane.ERROR_MESSAGE);
                            } else if (tipo.equals(Vino.SEMI_DULCE) && (azucar < 30 || azucar > 50)) {
                                JOptionPane.showMessageDialog(this,
                                        "El contenido en azúcar debe estar entre 30 y 50 si el tipo es semi dulce.",
                                        "Agregar vino", JOptionPane.ERROR_MESSAGE);
                            } else if (tipo.equals(Vino.DULCE) && azucar < 50) {
                                JOptionPane.showMessageDialog(this,
                                        "El contenido en azúcar debe ser mayor a 50 si el tipo es dulce.",
                                        "Agregar vino", JOptionPane.ERROR_MESSAGE);
                            } else {
                            ...
                            JOptionPane.showMessageDialog(this, "El contenido en azúcar debe ser mayor o igual a cero.",
                                    "Agregar vino", JOptionPane.ERROR_MESSAGE);
                        }
                    } else {
                        JOptionPane.showMessageDialog(this, "El año de elaboración debe ser mayor a cero.",
                                "Agregar vino", JOptionPane.ERROR_MESSAGE);
                    }
                } catch (NumberFormatException ex) {
                    JOptionPane.showMessageDialog(this,
                            "El año de elaboración y el contenido en azúcar del vino deben ser valores numéricos.",
                            "Agregar vino", JOptionPane.ERROR_MESSAGE);
                }
            } else {
                JOptionPane.showMessageDialog(this, "Por favor ingrese la información completa del vino.",
                        "Agregar vino", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
