...
/**
 * Clase usada para verificar que los métodos de la clase Cava están c
...
public class CupiCavaTest {
    ...
    public void setupEscenario2() {
        ...
        cupiCava.agregarVino("Marqués de Grión Reserva", Vino.BARRIL, 2000, 7, Vino.ABOCADO, Vino.TINTO,
                "Toledo, España", "imagen2");

        cupiCava.agregarVino("Castillo de Javier", Vino.BOTELLA, 2006, 20, Vino.SEMI_SECO, Vino.ROSADO,
                "Navarra, España", "imagen3");
    }
    ...
    /**
     * Prueba 6: Se encarga de verificar el método ordenarPorNombre de la 
     * lase.<br>
     * <b> Métodos a probar: </b> <br>
    ...
    public void testOrdenarVinosPorNombre() {
        ...
        // Verificar que el número de vinos no cambie
        assertEquals("El número de vinos no debe cambiar", 7, vinos.size());

        // Verificar que los vinos estén ordenados alfabéticamente
        for (int i = 0; i < vinos.size() - 1; i++) {
            Vino actual = vinos.get(i);
            Vino siguiente = vinos.get(i + 1);
            assertTrue("Los vinos deben estar ordenados alfabéticamente",
                    actual.darNombre().compareTo(siguiente.darNombre()) <= 0);
        }
    }

    /**
     * Prueba 7: Se encarga de verificar el método ordenarPorAnhoElaboracion de la
     * clase.<br>
     * <b> Métodos a probar: </b> <br>
     * 
    ...
    public void testOrdenarPorAnhoElaboracion() {
        ...
        // Verificar que los vinos estén ordenados por año
        for (int i = 0; i < vinos.size() - 1; i++) {
            Vino actual = vinos.get(i);
            Vino siguiente = vinos.get(i + 1);
            assertTrue("Los vinos deben estar ordenados por año",
                    actual.darAnhoElaboracion() <= siguiente.darAnhoElaboracion());
        }
    }

    /**
     * Prueba 8: Se encarga de verificar el método ordenarPorLugarOrigen de la
     * clase.<br>
     * <b> Métodos a probar: </b> <br>
     * 
    ...
    public void testOrdenarVinosPorLugarOrigen() {
        ...
        // Verificar que los vinos estén ordenados por lugar de origen
        for (int i = 0; i < vinos.size() - 1; i++) {
            Vino actual = vinos.get(i);
            Vino siguiente = vinos.get(i + 1);
    ...
    /**
     * Prueba 9: Se encarga de verificar el método buscarBinarioPorNombre de la 
     * lase.<br>
     * <b> Métodos a probar: </b> <br>
     * ordenarVinosPorNombre<br>
    ...
    public void testBuscarBinarioPorNombre() {
        ...
        assertNull("No debió haber encontrado un vino con el nombre dado.", 
                cupiCava.buscarBinarioPorNombre("inexistente"));
    }

    /**
     * Prueba 10: Se encarga de verificar el método buscarVinoMasDulce de la 
     * lase.<br>
     * <b> Métodos a probar: </b> <br>
    ...
    /**
     * Prueba 11: Se encarga de verificar el método buscarVinoMasSeco de la 
     * lase.<br>
     * <b> Métodos a probar: </b> <br>
    ...
    /**
     * Prueba 12: Se encarga de verificar el método buscarVinosDeTipo de la 
     * lase.<br>
     * <b> Métodos a probar: </b> <br>
